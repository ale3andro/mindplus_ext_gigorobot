#ifndef _Microbit_Matrix_alx_H_
#define _Microbit_Matrix_alx_H_
...
class Microbit_Matrix_alx// : public Print
{
    public:

    Microbit_Matrix_alx();
    ~Microbit_Matrix_alx(void);

    void      drawPixel(int16_t x, int16_t y, uint16_t color),
              drawTwoDigitNumber(int number),
              drawNumberInTwoColumns(int number, bool isUnits),
              clear(void),
...
extern Microbit_Matrix_alx AlxMatrix;
